...
def geneticoptimize(domain,costf,popsize=250,step=1,mutprob=0.2,elite=0.2,maxiter=100):
    # Mutation Operation
    def mutate(vec):
        i=random.randint(0,len(domain)-1)
...
if __name__ == "__main__":
    ...
    printschedule(s)
    print 'initial cost: ', schedulecost(s)

    domain = [(0,9)]*(len(people)*2)

    s = randomoptimize(domain, schedulecost)
    printschedule(s)
    print 'random optimize: ', schedulecost(s)
    ...
    printschedule(s)
    print 'genetic algorithm: ', schedulecost(s)